...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/spring/crm/linkManScreen"
		method=post>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
												<c:if test="${User.status eq 1}"><a href="${pageContext.request.contextPath }/spring/crm/findLinkManById/${list.linkid}">修改</a>
												        <a href="${pageContext.request.contextPath }/spring/crm/deleteLinkMan/${list.linkid}">删除</a>
												 </c:if>	
													&nbsp;&nbsp;
