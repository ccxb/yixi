...
<TD>
												<c:if test="${User.status eq 1 }">	  <a href="${pageContext.request.contextPath }/spring/crm/delVisit/${visit.vid}" >删除</a>
													 
													  <a href="${pageContext.request.contextPath }/spring/crm/findVisitById/${visit.vid}">修改</a> </c:if>
