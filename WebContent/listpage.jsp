...
<c:if test="${pageBean.currentPage!=1}">
	[<A href="${pageContext.request.contextPath }/spring/crm/findCustomerBypages/${pageBean.currentPage-1}">前一页</A>]
</c:if>
...
<c:if test="${pageBean.currentPage!=pageBean.totalPage}">
	[<A href="${pageContext.request.contextPath }/spring/crm/findCustomerBypages/${pageBean.currentPage+1}">后一页</A>] 
