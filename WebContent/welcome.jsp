...
<BODY>
			...
			<TBODY>
				<TR>
					<TD width=15><IMG src="<%=basePath%>img/new_019.jpg"
						border=0></TD>
					<TD width="100%" background=img/new_020.jpg
						height=20></TD>
		...
		<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
			<TBODY>
			<tr>
			   <TD width=15 background=img/new_022.jpg>
			   <IMG	src="<%=basePath%>img/new_022.jpg" border=0>
			   </TD>
					<TD align="center" bgColor=#ffffff>
						<table width="100%" height=545 border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td align="center"><img src="<%=basePath%>img/welcome.gif"
									width="145" height="46" /></td>
							</tr>
						</table>
					</td>
					<TD width=15 background=img/new_023.jpg>
				<IMG src="img/new_023.jpg" border=0>
				</TD>
			</tr>
			</TBODY>
		</table>
			...
			<TBODY>
				<TR>
					...
					<TD align=middle width="100%"
						background=img/new_025.jpg height=15></TD>
